...
<body >
    ...
    <!--LOGIN-->
     ...
     <div class="container">
        <div class="card card-container">
            ...
            <img id="profile-img" class="profile-img-card" src="imagenes/estadistica.svg" />
            <p id="profile-name" class="profile-name-card"></p>
            <form class="form-signin" action="validacion.php" method="POST">
                <span id="reauth-email" class="reauth-email"></span>
                
                <input type="text" id="inputEmail" class="form-control" placeholder="Cedula" required autofocus name="id_usuario">
    ...
    <footer class="page-footer font-small" style="background-color: #343A40; color: #FFF; margin-top: 150px">
      ...
      <div class="footer-copyright text-center py-3">© 2021 Todos los derechos reservados
        <br>
        <a href="" target="_blank">Encuestas Venezuela</a>
      </div>
      <!-- Copyright -->
